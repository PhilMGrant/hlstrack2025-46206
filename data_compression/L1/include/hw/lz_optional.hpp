...
#pragma HLS UNROLL
        ...
        compare_window_reg[c_max_match_length - 1] = compare_window[c_max_match_length - 1];
...
#pragma HLS UNROLL
            compressd_dt compareValue = compare_window_reg[j];
...
#pragma HLS PIPELINE II = 2  // 增加II值以解决时序违例
...
#pragma HLS PIPELINE II = 3  // 进一步增加II值以彻底解决时序违例
#pragma HLS dependence variable = local_mem inter false
        // 阶段1: 数据读取和local_mem写入
