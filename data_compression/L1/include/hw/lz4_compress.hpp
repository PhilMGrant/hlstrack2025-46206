...
#pragma HLS STREAM variable = lit_outStream depth = MAX_LIT_COUNT * 16  // 资源优化：从64减少到16，降低BRAM使用
#pragma HLS STREAM variable = lenOffset_Stream depth = c_gmemBurstSize * 16  // 资源优化：从64减少到16

#pragma HLS BIND_STORAGE variable = lit_outStream type = FIFO impl = BRAM  // 保持BRAM存储
#pragma HLS BIND_STORAGE variable = lenOffset_Stream type = FIFO impl = BRAM  // 保持BRAM存储
...
#pragma HLS STREAM variable = compressdStream depth = 32  // 效率优化：从8增加到32，改善数据流
#pragma HLS STREAM variable = bestMatchStream depth = 32  // 效率优化：从8增加到32，改善数据流
#pragma HLS STREAM variable = boosterStream depth = 32    // 效率优化：从8增加到32，改善数据流

#pragma HLS BIND_STORAGE variable = compressdStream type = FIFO impl = SRL  // 资源优化：保持SRL存储
#pragma HLS BIND_STORAGE variable = bestMatchStream type = FIFO impl = SRL  // 资源优化：保持SRL存储
#pragma HLS BIND_STORAGE variable = boosterStream type = FIFO impl = SRL    // 资源优化：保持SRL存储
