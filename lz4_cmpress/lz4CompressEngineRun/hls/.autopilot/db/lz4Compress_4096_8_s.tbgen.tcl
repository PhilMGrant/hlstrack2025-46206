set moduleName lz4Compress_4096_8_s
set isTopModule 0
...
set cdfgNum 19
set C_modelName {lz4Compress<4096, 8>}
...
set portList { 
	...
	{ max_lit_limit_address0 sc_out sc_lv 3 signal 2 } 
	{ max_lit_limit_ce0 sc_out sc_logic 1 signal 2 } 
	{ max_lit_limit_d0 sc_out sc_lv 32 signal 2 } 
	{ max_lit_limit_q0 sc_in sc_lv 32 signal 2 } 
	{ max_lit_limit_we0 sc_out sc_logic 1 signal 2 } 
	{ max_lit_limit_address1 sc_out sc_lv 3 signal 2 } 
	{ max_lit_limit_ce1 sc_out sc_logic 1 signal 2 } 
	{ max_lit_limit_d1 sc_out sc_lv 32 signal 2 } 
	{ max_lit_limit_q1 sc_in sc_lv 32 signal 2 } 
	{ max_lit_limit_we1 sc_out sc_logic 1 signal 2 } 
	...
	{ index_dout sc_in sc_lv 32 signal 6 } 
	{ index_empty_n sc_in sc_logic 1 signal 6 } 
	{ index_read sc_out sc_logic 1 signal 6 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "4", "7", "8", "9", "10"],
		...
		"IsBlackBox" : "0",
		"InputProcess" : [
			{"ID" : "1", "Name" : "lz4CompressPart1_4096_8_U0"}],
		"OutputProcess" : [
			{"ID" : "1", "Name" : "lz4CompressPart1_4096_8_U0"},
		...
		"Port" : [
			{"Name" : "boosterStream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "8", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "lz4CompressPart1_4096_8_U0", "Port" : "boosterStream"}]},
			...
			{"Name" : "max_lit_limit", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "lz4CompressPart1_4096_8_U0", "Port" : "max_lit_limit"}]},
			{"Name" : "input_size", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "lz4CompressPart1_4096_8_U0", "Port" : "input_size"}]},
			...
			{"Name" : "index", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "5", "DependentChanType" : "2",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "lz4CompressPart1_4096_8_U0", "Port" : "index"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lz4CompressPart1_4096_8_U0", "Parent" : "0", "Child" : ["2"],
		...
		"Port" : [
			{"Name" : "boosterStream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "8", "DependentChanType" : "0",
				...
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_lz4CompressPart1_4096_8_Pipeline_lz4_divide_fu_158", "Port" : "boosterStream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "lit_outStream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["4"], "DependentChan" : "7", "DependentChanDepth" : "65536", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_lz4CompressPart1_4096_8_Pipeline_lz4_divide_fu_158", "Port" : "lit_outStream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "lenOffset_Stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["4"], "DependentChan" : "8", "DependentChanDepth" : "512", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "lenOffset_Stream_blk_n", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_lz4CompressPart1_4096_8_Pipeline_lz4_divide_fu_158", "Port" : "lenOffset_Stream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "input_size", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.lz4CompressPart1_4096_8_U0.grp_lz4CompressPart1_4096_8_Pipeline_lz4_divide_fu_158", "Parent" : "1", "Child" : ["3"],
	...
	{"ID" : "3", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.lz4CompressPart1_4096_8_U0.grp_lz4CompressPart1_4096_8_Pipeline_lz4_divide_fu_158.flow_control_loop_pipe_sequential_init_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lz4CompressPart2_U0", "Parent" : "0", "Child" : ["5"],
		...
		"Port" : [
			{"Name" : "lit_outStream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "7", "DependentChanDepth" : "65536", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_lz4CompressPart2_Pipeline_lz4_compress_fu_91", "Port" : "lit_outStream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "lenOffset_Stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "8", "DependentChanDepth" : "512", "DependentChanType" : "0",
				"SubConnect" : [
...
set Spec2ImplPortList { 
	...
	index { ap_fifo {  { index_dout fifo_data_in 0 32 }  { index_empty_n fifo_status 0 1 }  { index_read fifo_port_we 1 1 } } }
}
