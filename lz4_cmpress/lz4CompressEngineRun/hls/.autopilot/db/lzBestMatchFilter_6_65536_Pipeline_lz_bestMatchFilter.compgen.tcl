...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bestMatchStream_din { O 32 vector } bestMatchStream_full_n { I 1 bit } bestMatchStream_write { O 1 bit } bestMatchStream_num_data_valid { I 4 vector } bestMatchStream_fifo_cap { I 4 vector } } \
} "
}
