...
set portList { 
	...
	{ bestMatchStream_num_data_valid sc_in sc_lv 4 signal 8 } 
	{ bestMatchStream_fifo_cap sc_in sc_lv 4 signal 8 } 
...
set Spec2ImplPortList { 
	...
	bestMatchStream { ap_fifo {  { bestMatchStream_din fifo_data_in 1 32 }  { bestMatchStream_full_n fifo_status 0 1 }  { bestMatchStream_write fifo_port_we 1 1 }  { bestMatchStream_num_data_valid fifo_status_num_data_valid 0 4 }  { bestMatchStream_fifo_cap fifo_update 0 4 } } }
