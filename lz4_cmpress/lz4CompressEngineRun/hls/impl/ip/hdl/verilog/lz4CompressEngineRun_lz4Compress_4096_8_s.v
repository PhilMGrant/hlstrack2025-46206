...
module lz4CompressEngineRun_lz4Compress_4096_8_s (
        boosterStream_dout,
...
wire    lz4CompressPart1_4096_8_U0_ap_start;
wire    lz4CompressPart1_4096_8_U0_ap_done;
wire    lz4CompressPart1_4096_8_U0_ap_continue;
wire    lz4CompressPart1_4096_8_U0_ap_idle;
wire    lz4CompressPart1_4096_8_U0_ap_ready;
wire    lz4CompressPart1_4096_8_U0_start_out;
wire    lz4CompressPart1_4096_8_U0_start_write;
wire    lz4CompressPart1_4096_8_U0_boosterStream_read;
wire   [7:0] lz4CompressPart1_4096_8_U0_lit_outStream_din;
wire    lz4CompressPart1_4096_8_U0_lit_outStream_write;
wire   [63:0] lz4CompressPart1_4096_8_U0_lenOffset_Stream_din;
wire    lz4CompressPart1_4096_8_U0_lenOffset_Stream_write;
wire    lz4CompressPart1_4096_8_U0_input_size_read;
wire   [2:0] lz4CompressPart1_4096_8_U0_max_lit_limit_address0;
wire    lz4CompressPart1_4096_8_U0_max_lit_limit_ce0;
wire    lz4CompressPart1_4096_8_U0_max_lit_limit_we0;
wire   [31:0] lz4CompressPart1_4096_8_U0_max_lit_limit_d0;
wire    lz4CompressPart1_4096_8_U0_index_read;
wire   [31:0] lz4CompressPart1_4096_8_U0_input_size_c_din;
wire    lz4CompressPart1_4096_8_U0_input_size_c_write;
...
wire   [16:0] lit_outStream_num_data_valid;
wire   [16:0] lit_outStream_fifo_cap;
wire    lenOffset_Stream_full_n;
wire   [63:0] lenOffset_Stream_dout;
wire    lenOffset_Stream_empty_n;
wire   [9:0] lenOffset_Stream_num_data_valid;
wire   [9:0] lenOffset_Stream_fifo_cap;
...
lz4CompressEngineRun_lz4CompressPart1_4096_8_s lz4CompressPart1_4096_8_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
lz4CompressEngineRun_fifo_w8_d65536_B lit_outStream_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
lz4CompressEngineRun_fifo_w64_d512_B lenOffset_Stream_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (lz4CompressPart2_U0_ap_idle & lz4CompressPart1_4096_8_U0_ap_idle);

assign ap_ready = lz4CompressPart1_4096_8_U0_ap_ready;

assign ap_sync_continue = (ap_sync_done & ap_continue);

assign ap_sync_done = (lz4CompressPart2_U0_ap_done & lz4CompressPart1_4096_8_U0_ap_done);

assign boosterStream_read = lz4CompressPart1_4096_8_U0_boosterStream_read;

assign index_read = lz4CompressPart1_4096_8_U0_index_read;

assign input_size_read = lz4CompressPart1_4096_8_U0_input_size_read;

assign lz4CompressPart1_4096_8_U0_ap_continue = ap_sync_continue;

assign lz4CompressPart1_4096_8_U0_ap_start = ap_start;
...
assign max_lit_limit_address0 = lz4CompressPart1_4096_8_U0_max_lit_limit_address0;

assign max_lit_limit_address1 = 3'd0;

assign max_lit_limit_ce0 = lz4CompressPart1_4096_8_U0_max_lit_limit_ce0;

assign max_lit_limit_ce1 = 1'b0;

assign max_lit_limit_d0 = lz4CompressPart1_4096_8_U0_max_lit_limit_d0;

assign max_lit_limit_d1 = 32'd0;

assign max_lit_limit_we0 = lz4CompressPart1_4096_8_U0_max_lit_limit_we0;

assign max_lit_limit_we1 = 1'b0;

assign start_for_lz4CompressPart2_U0_din = 1'b1;

endmodule //lz4CompressEngineRun_lz4Compress_4096_8_s
