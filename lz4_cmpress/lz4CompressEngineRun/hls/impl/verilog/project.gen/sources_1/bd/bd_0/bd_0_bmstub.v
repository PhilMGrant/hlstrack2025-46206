...
module bd_0 (
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.AP_CLK, FREQ_HZ 142000000.0, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN bd_0_ap_clk_0, ASSOCIATED_RESET ap_rst, INSERT_VIP 0" *)
  input ap_clk;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.MAX_LIT_LIMIT_ADDRESS0 DATA" *)
  (* X_INTERFACE_MODE = "master DATA.MAX_LIT_LIMIT_ADDRESS0" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.MAX_LIT_LIMIT_ADDRESS0, LAYERED_METADATA undef" *)
  output [2:0]max_lit_limit_address0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.MAX_LIT_LIMIT_ADDRESS1 DATA" *)
  (* X_INTERFACE_MODE = "master DATA.MAX_LIT_LIMIT_ADDRESS1" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.MAX_LIT_LIMIT_ADDRESS1, LAYERED_METADATA undef" *)
  output [2:0]max_lit_limit_address1;
  (* X_INTERFACE_IGNORE = "true" *)
  output max_lit_limit_ce0;
  (* X_INTERFACE_IGNORE = "true" *)
  output max_lit_limit_ce1;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.MAX_LIT_LIMIT_D0 DATA" *)
  (* X_INTERFACE_MODE = "master DATA.MAX_LIT_LIMIT_D0" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.MAX_LIT_LIMIT_D0, LAYERED_METADATA undef" *)
  output [31:0]max_lit_limit_d0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.MAX_LIT_LIMIT_D1 DATA" *)
  (* X_INTERFACE_MODE = "master DATA.MAX_LIT_LIMIT_D1" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.MAX_LIT_LIMIT_D1, LAYERED_METADATA undef" *)
  output [31:0]max_lit_limit_d1;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.MAX_LIT_LIMIT_Q0 DATA" *)
  (* X_INTERFACE_MODE = "slave DATA.MAX_LIT_LIMIT_Q0" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.MAX_LIT_LIMIT_Q0, LAYERED_METADATA undef" *)
  input [31:0]max_lit_limit_q0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.MAX_LIT_LIMIT_Q1 DATA" *)
  (* X_INTERFACE_MODE = "slave DATA.MAX_LIT_LIMIT_Q1" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.MAX_LIT_LIMIT_Q1, LAYERED_METADATA undef" *)
