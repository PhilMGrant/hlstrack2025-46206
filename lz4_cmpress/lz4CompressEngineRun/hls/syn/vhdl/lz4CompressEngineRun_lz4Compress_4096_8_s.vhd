...
entity lz4CompressEngineRun_lz4Compress_4096_8_s is
port (
...
architecture behav of lz4CompressEngineRun_lz4Compress_4096_8_s is 
...
attribute shreg_extract : string;
    signal lz4CompressPart1_4096_8_U0_ap_start : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_ap_done : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_ap_continue : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_ap_idle : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_ap_ready : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_start_out : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_start_write : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_boosterStream_read : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_lit_outStream_din : STD_LOGIC_VECTOR (7 downto 0);
    signal lz4CompressPart1_4096_8_U0_lit_outStream_write : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_lenOffset_Stream_din : STD_LOGIC_VECTOR (63 downto 0);
    signal lz4CompressPart1_4096_8_U0_lenOffset_Stream_write : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_input_size_read : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_max_lit_limit_address0 : STD_LOGIC_VECTOR (2 downto 0);
    signal lz4CompressPart1_4096_8_U0_max_lit_limit_ce0 : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_max_lit_limit_we0 : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_max_lit_limit_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal lz4CompressPart1_4096_8_U0_index_read : STD_LOGIC;
    signal lz4CompressPart1_4096_8_U0_input_size_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal lz4CompressPart1_4096_8_U0_input_size_c_write : STD_LOGIC;
    ...
    signal lit_outStream_num_data_valid : STD_LOGIC_VECTOR (16 downto 0);
    signal lit_outStream_fifo_cap : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal lenOffset_Stream_num_data_valid : STD_LOGIC_VECTOR (9 downto 0);
    signal lenOffset_Stream_fifo_cap : STD_LOGIC_VECTOR (9 downto 0);
    ...
    component lz4CompressEngineRun_lz4CompressPart1_4096_8_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component lz4CompressEngineRun_fifo_w8_d65536_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component lz4CompressEngineRun_fifo_w64_d512_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    lz4CompressPart1_4096_8_U0 : component lz4CompressEngineRun_lz4CompressPart1_4096_8_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => lz4CompressPart1_4096_8_U0_ap_start,
        start_full_n => start_for_lz4CompressPart2_U0_full_n,
        ap_done => lz4CompressPart1_4096_8_U0_ap_done,
        ap_continue => lz4CompressPart1_4096_8_U0_ap_continue,
        ap_idle => lz4CompressPart1_4096_8_U0_ap_idle,
        ap_ready => lz4CompressPart1_4096_8_U0_ap_ready,
        start_out => lz4CompressPart1_4096_8_U0_start_out,
        start_write => lz4CompressPart1_4096_8_U0_start_write,
        boosterStream_dout => boosterStream_dout,
        boosterStream_empty_n => boosterStream_empty_n,
        boosterStream_read => lz4CompressPart1_4096_8_U0_boosterStream_read,
        boosterStream_num_data_valid => ap_const_lv4_0,
        boosterStream_fifo_cap => ap_const_lv4_0,
        lit_outStream_din => lz4CompressPart1_4096_8_U0_lit_outStream_din,
        lit_outStream_full_n => lit_outStream_full_n,
        lit_outStream_write => lz4CompressPart1_4096_8_U0_lit_outStream_write,
        lit_outStream_num_data_valid => lit_outStream_num_data_valid,
        lit_outStream_fifo_cap => lit_outStream_fifo_cap,
        lenOffset_Stream_din => lz4CompressPart1_4096_8_U0_lenOffset_Stream_din,
        lenOffset_Stream_full_n => lenOffset_Stream_full_n,
        lenOffset_Stream_write => lz4CompressPart1_4096_8_U0_lenOffset_Stream_write,
        ...
        input_size_read => lz4CompressPart1_4096_8_U0_input_size_read,
        input_size_num_data_valid => ap_const_lv3_0,
        input_size_fifo_cap => ap_const_lv3_0,
        max_lit_limit_address0 => lz4CompressPart1_4096_8_U0_max_lit_limit_address0,
        max_lit_limit_ce0 => lz4CompressPart1_4096_8_U0_max_lit_limit_ce0,
        max_lit_limit_we0 => lz4CompressPart1_4096_8_U0_max_lit_limit_we0,
        max_lit_limit_d0 => lz4CompressPart1_4096_8_U0_max_lit_limit_d0,
        index_dout => index_dout,
        index_empty_n => index_empty_n,
        index_read => lz4CompressPart1_4096_8_U0_index_read,
        index_num_data_valid => ap_const_lv4_0,
        index_fifo_cap => ap_const_lv4_0,
        input_size_c_din => lz4CompressPart1_4096_8_U0_input_size_c_din,
        input_size_c_full_n => input_size_c_full_n,
        input_size_c_write => lz4CompressPart1_4096_8_U0_input_size_c_write,
    ...
    lit_outStream_U : component lz4CompressEngineRun_fifo_w8_d65536_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => lz4CompressPart1_4096_8_U0_lit_outStream_din,
        if_full_n => lit_outStream_full_n,
        if_write => lz4CompressPart1_4096_8_U0_lit_outStream_write,
    ...
    lenOffset_Stream_U : component lz4CompressEngineRun_fifo_w64_d512_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => lz4CompressPart1_4096_8_U0_lenOffset_Stream_din,
        if_full_n => lenOffset_Stream_full_n,
        if_write => lz4CompressPart1_4096_8_U0_lenOffset_Stream_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => lz4CompressPart1_4096_8_U0_input_size_c_din,
        if_full_n => input_size_c_full_n,
        if_write => lz4CompressPart1_4096_8_U0_input_size_c_write,
    ...
    port map (
        ...
        if_write => lz4CompressPart1_4096_8_U0_start_write,
    ...
    ap_idle <= (lz4CompressPart2_U0_ap_idle and lz4CompressPart1_4096_8_U0_ap_idle);
    ap_ready <= lz4CompressPart1_4096_8_U0_ap_ready;
    ap_sync_continue <= (ap_sync_done and ap_continue);
    ap_sync_done <= (lz4CompressPart2_U0_ap_done and lz4CompressPart1_4096_8_U0_ap_done);
    boosterStream_read <= lz4CompressPart1_4096_8_U0_boosterStream_read;
    index_read <= lz4CompressPart1_4096_8_U0_index_read;
    input_size_read <= lz4CompressPart1_4096_8_U0_input_size_read;
    lz4CompressPart1_4096_8_U0_ap_continue <= ap_sync_continue;
    lz4CompressPart1_4096_8_U0_ap_start <= ap_start;
