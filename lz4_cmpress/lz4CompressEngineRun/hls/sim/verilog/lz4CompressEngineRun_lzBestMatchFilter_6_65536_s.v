...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state11) & (1'b0 == ap_block_state11) & ((icmp_ln388_fu_216_p2 == 1'd1) | (icmp_ln327_reg_301 == 1'd1)))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((compressdStream_empty_n == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        i_8_fu_104 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state11) & (1'b0 == ap_block_state11) & (icmp_ln388_fu_216_p2 == 1'd0) & (icmp_ln327_reg_301 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state11) & (1'b0 == ap_block_state11) & ((icmp_ln388_fu_216_p2 == 1'd1) | (icmp_ln327_reg_301 == 1'd1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state11) & (icmp_ln388_fu_216_p2 == 1'd0) & (icmp_ln327_reg_301 == 1'd0))) begin
...
assign add_ln388_fu_222_p2 = (i_8_fu_104 + 3'd1);
...
always @ (*) begin
    ap_predicate_op54_write_state11 = ((icmp_ln388_fu_216_p2 == 1'd0) & (icmp_ln327_reg_301 == 1'd0));
end
...
assign icmp_ln388_fu_216_p2 = ((i_8_fu_104 == 3'd6) ? 1'b1 : 1'b0);
