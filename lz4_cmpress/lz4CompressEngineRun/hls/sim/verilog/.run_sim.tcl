...
proc run_exec {fileExe} {
	...
	set err {}
set ret [catch {eval exec "./$fileExe D:/Xillinx_Project/PROJECT/data_compression/L1/tests/lz4_compress/../../../L1/tests/lz4_compress/sample.txt D:/Xillinx_Project/PROJECT/data_compression/L1/tests/lz4_compress/../../../L1/tests/lz4_compress/sample.txt.encoded | tee tmp.log" >&@ stdout} err]
