...
set name kernel_cholesky_0_dsqrt_64ns_64ns_64_57_no_dsp_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kernel_cholesky_0_ctlz_34_34_1_1 BINDTYPE {op} TYPE {ctlz} IMPL {auto}
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kernel_cholesky_0_sparsemux_7_2_17_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {onehotencoding_realdef}
}
...
set name kernel_cholesky_0_sdiv_34ns_19s_34_38_1
if {${::AESL::PGuard_rtl_comp_handler}} {
